...
#define D_AP1_SSID "WiFi 네트워크"
#define D_AP1_SSID_HELP "WiFi 네트워크를 선택하거나 입력해주세요"
#define D_AP2_SSID "WiFi 네트워크 2"
#define D_AP2_SSID_HELP "접속이 안될 경우, 대체할 네트워크를 입력해주세요"
