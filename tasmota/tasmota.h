...
const char WIFI_HOSTNAME[] = "ZIGBANG";     // Expands to <MQTT_TOPIC>-<last 4 decimal chars of MAC address>
...
enum SettingsTextIndex { SET_ID_TOKEN, SET_PNU, SET_DONGHO, SET_ENV, SET_OTAURL, SET_CERT_ARN,
