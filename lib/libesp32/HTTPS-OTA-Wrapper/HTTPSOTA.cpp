...
HTTPSOTAClass& HTTPSOTAClass::onStart(THandlerFunction fn) {
    _start_callback = fn;
    return *this;
}

HTTPSOTAClass& HTTPSOTAClass::onEnd(THandlerFunction fn) {
    _end_callback = fn;
    return *this;
}

HTTPSOTAClass& HTTPSOTAClass::onProgress(THandlerFunction_Progress fn) {
    _progress_callback = fn;
    return *this;
}

HTTPSOTAClass& HTTPSOTAClass::onError(THandlerFunction_Error fn) {
    _error_callback = fn;
    return *this;
}

HTTPSOTAClass& HTTPSOTAClass::setPort(uint16_t port) {
...
HTTPSOTAClass& HTTPSOTAClass::setHostname(const char * hostname) {
...
String HTTPSOTAClass::getHostname() {
    return _hostname;
}

HTTPSOTAClass& HTTPSOTAClass::setPassword(const char * password) {
...
HTTPSOTAClass& HTTPSOTAClass::setPasswordHash(const char * password) {
    if (!_initialized && !_password.length() && password) {
        _password = password;
    }
    return *this;
...
HTTPSOTAClass& HTTPSOTAClass::setPartitionLabel(const char * partition_label) {
...
String HTTPSOTAClass::getPartitionLabel() {
    return _partition_label;
}

HTTPSOTAClass& HTTPSOTAClass::setRebootOnSuccess(bool reboot){
    _rebootOnSuccess = reboot;
    return *this;
}

HTTPSOTAClass& HTTPSOTAClass::setMdnsEnabled(bool enabled){
    _mdnsEnabled = enabled;
    return *this;
}

bool HTTPSOTAClass::begin() {
    if (_initialized){
...
String HTTPSOTAClass::readStringUntil(char end){
    String res = "";
    int value;
    while(true){
        value = _udp_ota.read();
...
int HTTPSOTAClass::getCommand() {
    return _cmd;
}

void HTTPSOTAClass::setTimeout(int timeoutInMillis) {
